                    ...
                    <div className={s.swiper__card}>
                        ...
                        <div className={s.card__content}>
                            ...
                            <div className={s.card__paragraph}>
                                ...
                                связанные с исследованием рукописных документов,
                                различных подписей и записей.
                            </div>
                            <div className={s.card__paragraph}>
                            ...
                            <div className={s.card__paragraph}>
                                ...
                                направляются: определение (постановление) суда о
                                назначении экспертизы; исследуемые документы в
                                оригиналах, либо их электрофотографические копии
                                высокого качества (с указанием причины
                                отсутствия подлинника); образцы почерка и
                                подписи предполагаемого исполнителя (см.
                                следующую карточку).
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={s.swiper__card}>
                        ...
                        <div className={s.card__content}>
                            <div className={s.card__title}>
                                ...
                                />
                                <h3 className={s.card__heading}>
                                    Образцы почерка для исследования
                                </h3>
                            </div>
                            <div className={s.card__paragraph}>
                                Свободными образцами являются тексты и подписи,
                                выполненные предполагаемым исполнителем вне
                                связи с делом, по которому проводится
                                экспертиза, и до возбуждения этого дела -
                                анкеты, заявления, конспекты, платежные
                                ведомости, копия паспорта и пр.
                            </div>
                            <div className={s.card__paragraph}>
                                Условно-свободными образцами являются тексты и
                                подписи в документах, которые выполнены после
                                возникновения дела, но не специально для
                                проведения экспертизы - исковые заявления,
                                объяснения, ходатайства, жалобы, протоколы
                                допросов и другие рукописи, выполненные во время
                                ведения дела.
                            </div>
                            <div className={s.card__paragraph}>
                                Экспериментальными образцами являются тексты и
                                подписи, которые по предложению судьи или
                                следователя выполняются предполагаемым
