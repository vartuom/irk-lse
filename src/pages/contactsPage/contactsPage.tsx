        ...
        <main className={s.main}>
            ...
            <section className={s.section_grid}>
                <div>
                    <div className={s.contacts}>
                        ...
                        <div>
                            ...
                            <p className={s.contacts__paragraph}>
                                Электронная почта: <span className={'spanAccent'}>sudexpert@irk.ru</span>
                            </p>
                        </div>
                        <div>
                            <p className={s.contacts__paragraph}>
                    ...
                    <AppAccordion title={'Отделы и подразделения'} noBorders>
                        <div className={s.contacts}>
                            <div>
                                <p className={`${s.contacts__paragraph} ${s.contacts__paragraph_type_accent}`}>
                ...
                <div>
                    ...
                    <AppAccordion title={'Карточка сведений о контрагенте и банковские реквизиты'} noBorders>
                        <div className={s.contacts}>
                            <div>
                                <p className={`${s.contacts__paragraph} ${s.contacts__paragraph_type_accent}`}>
                                    Отдел исследования почерка и документов:
                    ...
                    <AppAccordion title={'Политика для целей бухгалтерского учета'} noBorders>
                        <div className={s.contacts}>
                            <div>
                                <p className={`${s.contacts__paragraph} ${s.contacts__paragraph_type_accent}`}>
                                    Отдел исследования почерка и документов:
