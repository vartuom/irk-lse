      ...
      <section className={s.section_grid}>
        <div>
          <div className={s.contacts}>
            <p className={s.contacts__title}>ФБУ Иркутская ЛСЭ Миюста России</p>
            <div>
              ...
              <p className={s.contacts__paragraph}>
                Электронная почта:{' '}
                <span className="spanAccent">sudexpert@irk.ru</span>
              </p>
            </div>
            <div>
              <p className={s.contacts__paragraph}>
                пн.-чт. с 08:00 до 17:00 (перерыв с 12:30 до 13:20)
              </p>
              <p className={s.contacts__paragraph}>
                пт. с 08:00 до 16:10 (перерыв с 12:30 до 13:20)
              </p>
              <p className={s.contacts__paragraph}>сб.-вс. выходной</p>
            </div>
            <div>
              <div className={s.contacts__number}>
                <p className={s.contacts__paragraph}>Начальник</p>
                <p className={s.contacts__paragraph}>т. 8 (3952) 70-22-98</p>
              </div>
              <div className={s.contacts__number}>
                <p className={s.contacts__paragraph}>Канцелярия</p>
                <p className={s.contacts__paragraph}>т. 8 (3952) 70-22-97</p>
              </div>
            </div>
            <p className={s.contacts__paragraph}>
              Прием обращений возможен в электронной форме с использованием
              <span className="spanAccent"> страницы обращений граждан</span>,
          ...
          <AppAccordion title="Отделы и подразделения" noBorders>
            <div className={s.contacts}>
              <div>
                ...
                <p className={s.contacts__paragraph}>т. 8 (3952) 70-23-52</p>
              </div>
              <div>
                <p
                  className={`${s.contacts__paragraph} ${s.contacts__paragraph_type_accent}`}
                >
                  Отдел экономических и строительно-технических исследований:
                </p>
                <p className={s.contacts__paragraph}>т. 8 (3952) 70-23-20</p>
              </div>
              <div>
                <p
                  className={`${s.contacts__paragraph} ${s.contacts__paragraph_type_accent}`}
                ...
                <p className={s.contacts__paragraph}>т. 8 (3952) 70-23-22</p>
              </div>
            </div>
          </AppAccordion>
        </div>
