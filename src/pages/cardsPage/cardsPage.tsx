  ...
  return (
    <main className={s.main}>
        ...
        <div>
          ...
          <div className={s.lead__textContainer}>
            ...
            <p className={s.lead__paragraph}>
              ...
              ответами на самые важные вопросы:
              {' '}
              <span className="spanAccent">  понятия, оплата исследований, виды и роды экспертиз</span>
              .
            </p>
          </div>
        </div>
      ...
      <div className={s.swiper__container}>
        <Swiper slidesPerView="auto" centeredSlides spaceBetween={30} pagination navigation modules={[Pagination, Navigation]} className="mySwiper">
